...
let poll = constants.POLL_RATE; // the time between each poll for board editing listeners
let mouseX = 0;
let mouseY = 0;
let lastTimestamp;
...
function animate(timestamp) {
    ...
    if (poll < 0) {
        ...
        poll = constants.POLL_RATE;
    }
    window.requestAnimationFrame(animate);
}
animate();
compileBoard();
// module.exports = {enterTextMode, leaveTextMode, setColor, clearBoard, compileBoard, plotPenPoint, updateRect, animate};